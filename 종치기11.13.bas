...
굽힘자세:
    ...
    MOVE G6A,100,  76, 135,  113, 100, 100
    MOVE G6D,100,  76, 135,  113, 100, 100
    MOVE G6B,100,  30,  80,
    MOVE G6C,100,  30,  80,
    WAIT
    mode = 0
...
계단왼발오르기3cm:
    ...
    SPEED 12
    MOVE G6A,  80, 40, 115, 155, 114,
    MOVE G6D,113,  70, 155,  90,  94
    WAIT
	
	SPEED 7
    MOVE G6A,  90, 50, 115, 160, 110,
    MOVE G6D,110,  80, 145,  90,  94
    WAIT
    
    GOSUB Leg_motor_mode3
    
    SPEED 7
    MOVE G6A, 105, 60, 123, 180, 100
    MOVE G6D,90,  90, 165,  70, 100
    MOVE G6B,160,50
    MOVE G6C,160,30
    WAIT
    ...
    SPEED 12
    MOVE G6A, 114, 90, 100, 150,95,
    MOVE G6D,90,  130, 80,  140, 108
    WAIT
    
	SPEED 10
    MOVE G6A, 114, 90, 100, 150,95,
    MOVE G6D,90,  110, 100,  140, 108
    MOVE G6B,140,50
    MOVE G6C,140,30
    WAIT
    
    SPEED 10
    MOVE G6A, 114, 90, 100, 130,95,
    MOVE G6D,90,  110, 100,  130, 108
    MOVE G6B,140,50
    MOVE G6C,140,30
    WAIT
...
계단오른발오르기3cm:
    ...
    SPEED 12
    MOVE G6D,  80, 40, 115, 155, 114,
    MOVE G6A,113,  70, 155,  90,  94
    WAIT
	
	SPEED 7
    MOVE G6D,  90, 50, 115, 160, 110,
    MOVE G6A,113,  80, 145,  90,  94
    WAIT
    
    GOSUB Leg_motor_mode3

    SPEED 7
    MOVE G6D, 105, 60, 123, 180, 100
    MOVE G6A,90,  90, 165,  70, 100
    MOVE G6C,160,50
    MOVE G6B,160,40
    WAIT
    ...
    SPEED 12
    MOVE G6D, 114, 90, 100, 150,95,
    MOVE G6A,90,  130, 80,  140, 108
    WAIT
    
	SPEED 10
    MOVE G6D, 114, 90, 100, 150,95,
    MOVE G6A,90,  110, 100,  140, 108
    MOVE G6C,140,50
    MOVE G6B,140,30
    WAIT
    
    SPEED 10
    MOVE G6D, 114, 90, 100, 130,95,
    MOVE G6A,90,  110, 100,  130, 108
    MOVE G6C,140,50
    MOVE G6B,140,30
    WAIT
    
    SPEED 10
    MOVE G6D, 114, 90, 105, 130,95,
...
계단오른발오르기1cm:
    ...
    SPEED 3
    MOVE G6D, 88,  71, 142,  101, 110
    MOVE G6A,108,  77, 136,  103,  94
    MOVE G6B,100,40
    MOVE G6C,100,40
    WAIT

    SPEED 5
    MOVE G6D, 90, 100, 110, 105, 114
    MOVE G6A,113,  78, 146,  98,  94
    WAIT
    ...
    MOVE G6A,113,  71, 155,  95,  94
    WAIT


    SPEED 9
    MOVE G6D,  80, 55, 130, 145, 114,
    MOVE G6A,113,  70, 155,  95,  94
    WAIT
...
계단왼발내려가기1cm:
	...
	'SPEED 3
    'MOVE G6A, 114, 90, 90, 145,95,
    'MOVE G6D,95,  100, 165,  65, 100
    'MOVE G6B,180,50
    'MOVE G6C,180,30
    'WAIT
    
    SPEED 4
    MOVE G6A, 105, 75, 100, 150, 100,
    MOVE G6D,95,  95, 175,  65, 103
    MOVE G6B,160,50
    MOVE G6C,160,40
    WAIT
    
    MOVE G6A, 105, 55, 100, 170, 105,
    MOVE G6D,95,  95, 175,  65, 90
    MOVE G6B,160,50
    MOVE G6C,160,40
    WAIT
    
    SPEED 4
    MOVE G6A, 105, 105, 70, 180, 100,
    MOVE G6D,95,  95, 185,  65, 100
    MOVE G6B,160,50
    MOVE G6C,160,40
    WAIT
...
종치기:
	...
	MOVE G6B, 190,  24,  87, 100, 100, 101
	MOVE G6C, 189,  33,  81, 100,  99, 100
	WAIT
		
	MOVE G6B, 181, 100,  91, 100, 100, 101
	MOVE G6C, 189,  10,  38, 100,  99, 100
	WAIT

	MOVE G6B, 187,  12,  35, 100, 100, 101
	MOVE G6C, 189, 101, 109, 100,  99, 100
	WAIT
...
뒤로기어가기:
	...
	MOVE G6D, 100, 140,  80, 160, 100
	MOVE G6A, 100, 140, 120, 120, 100
	MOVE G6C, 160,  25,  70, 100, 180, 100
	MOVE G6B, 190,  25,  70
	WAIT
	
	MOVE G6D, 100, 160,  55, 160, 100
	MOVE G6A, 100, 145,  75, 160, 100
	MOVE G6C, 175,  25,  70, 100, 180, 100
	MOVE G6B, 190,  50,  40
	WAIT
	...
	MOVE G6D, 100, 140, 120, 120, 100
	MOVE G6B, 160,  25,  70
	MOVE G6C, 190,  25,  70, 100, 180, 100
	WAIT
	
	MOVE G6A, 108, 172,  43, 158,  99, 100
	MOVE G6D,  96, 155, 119, 101,  99, 100
	MOVE G6B, 161,  25,  59, 100, 100, 101
	MOVE G6C, 187,  27,  70, 100, 112, 100
	WAIT
